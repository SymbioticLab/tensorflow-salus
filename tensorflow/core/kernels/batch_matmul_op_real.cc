...
TF_CALL_float(REGISTER_BATCH_MATMUL_RPC);
TF_CALL_double(REGISTER_BATCH_MATMUL_RPC);
TF_CALL_half(REGISTER_BATCH_MATMUL_RPC);
TF_CALL_int32(REGISTER_BATCH_MATMUL_RPC);
